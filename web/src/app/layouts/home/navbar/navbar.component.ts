...
@Component({
  selector: 'app-layout-home-navbar',
...
export class NavbarComponent implements OnInit {
  ...
  onWindowScroll() {
    let element = document.querySelector('#home-navbar') as HTMLElement;
    if (window.pageYOffset > element.clientHeight) {
      element.classList.add('navbar-add-background');
      element.classList.remove('navbar-add-transparent');
    } else {
      element.classList.remove('navbar-add-background');
      element.classList.add('navbar-add-transparent');
    }
  }
